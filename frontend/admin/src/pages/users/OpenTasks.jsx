...
import AddTimeModal from '../../member/AddTimeModal';
import { useAppContext } from '../../context/AppContext';
const Tasks = ({id , onTaskCountChange}) => {
...
axios
  ...
  //   }, []);
    ...
    const fetchData = () => {
      axios
        .get(`http://localhost:5000/task/Mtasks/${id}`)
        .then((res) => {
          setTableData(res.data);
          onTaskCountChange(res.data.length);
...
const handleCloseModal = () => setShowModal3(false);
  ...
  return (
    <div>
      <div
              className=" pt-4 pb-4 px-3 d-flex flex-row"
              style={{
